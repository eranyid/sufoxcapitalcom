...
import { LayoutDashboard, TrendingUp, Shield, ArrowRightLeft, Calendar, Settings, ChevronLeft, ChevronRight, Scan, LogOut, Activity, FileCheck, Users, Search, Building2, HelpCircle } from 'lucide-react';
