...
export function FxRatesIcon({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }) {
  return (
    <svg
      height={size}
      width={size}
    ...
    >
      ...
      <g opacity="0.4">
        <path d="M5 15V8" />
        <path d="M5.12891 15C5.57891 13.25 7.1789 11.95 9.0689 11.96L12.4989 11.97C15.1189 11.98 17.3489 10.3 18.1689 7.95996" />
      </g>
    </svg>
  );
}
