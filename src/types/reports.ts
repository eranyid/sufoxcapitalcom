...
export const SECTION_LIBRARY: { type: ReportSectionType; label: string; description: string }[] = [
  ...
  { type: 'performance_calendar', label: 'Performance Calendar', description: 'Monthly returns heatmap by year' },
  { type: 'contribution_chart', label: 'Contribution to Return', description: 'Top contributors and detractors' },
  { type: 'top_movers', label: 'Top Movers', description: 'Best and worst performers' },
  ...
  { type: 'geographic_allocation', label: 'Geographic Allocation', description: 'Regional distribution' },
