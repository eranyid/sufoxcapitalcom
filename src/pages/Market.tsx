        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              AI-powered fundamental data & metrics for any ticker
            </p>
          </div>
        </div>
        ...
        {data && !loading && (
          <div className="space-y-4">
            ...
            <p className="text-[9px] text-muted-foreground/50 text-center px-4">
              Data generated by AI and may not be fully accurate. This is not investment advice. Always verify with official financial sources.
            </p>
          </div>
        )}
      </div>
